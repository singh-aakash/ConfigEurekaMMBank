...
public class BankAppController {
	...
	public String deposit(@ModelAttribute Transaction transaction,
			Model model) {
		restTemplate.postForEntity("http://transactionsProperties/transactions", transaction, null);
	...
	public String withdraw(@ModelAttribute Transaction transaction,
			Model model) {
		restTemplate.postForEntity("http://transactionsProperties/transactions/withdraw", transaction, null);
	...
	public ModelAndView getStatementFundTransfer(@RequestParam("offset") int offset, @RequestParam("size") int size) {
		...
		CurrentDataSet currentDataSet = restTemplate.getForObject("http://transactionsProperties/transactions/statement", CurrentDataSet.class);
